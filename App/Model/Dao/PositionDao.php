...
/**
 * This class represents the Dao object of the position
 * entity.
 * 
 * @category  PositionDao
 * @package   Josevaltersilvacarneiro\Html\App\Model\Dao
 * @author    José Carneiro <git@josevaltersilvacarneiro.net>
...
final class PositionDao extends GenericDao
{
    /**
     * Initializes the PositionDao object.
     * 
     * @return void
     */
    public function __construct()
    {
        parent::__construct(Connect::newMysqlConnection(), _TB_POSITIONAME);
    }
}
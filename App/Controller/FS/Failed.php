...
/**
 * This class shows the fail status.
 * 
 * @category  Failed
 * @package   Josevaltersilvacarneiro\Html\App\Controllers\Failed
 * @author    José Carneiro <git@josevaltersilvacarneiro.net>
 ...
 */
final class Failed extends HTMLController
{
    /**
     * Initializes the failed object.
     * 
    ...
    {
        $this->setPage('Failed');
        $this->setTitle('PDV - Houve um erro');
        $this->setDescription('Esta página é exibida quando ocorre um erro ou uma ação não pode ser concluída.');
        $this->setKeywords('PDV Joilma Erro josevaltersilvacarneiro');
    }

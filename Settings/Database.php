...
define('_HOST_MYSQL', $_ENV['HOST_MYSQL'] ?? getenv('HOST_MYSQL'));
define('_DBNAME_MYSQL', $_ENV['DB_MYSQL'] ?? getenv('DB_MYSQL'));
define('_USER_MYSQL', $_ENV['USER_MYSQL'] ?? getenv('USER_MYSQL'));
define('_PASS_MYSQL', $_ENV['PASS_MYSQL'] ?? getenv('PASS_MYSQL'));
